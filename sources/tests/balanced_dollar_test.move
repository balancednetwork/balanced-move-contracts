...
module balanced::balanced_dollar_test {
    ...
    fun setup_test(admin:address):Scenario {
        ...
        xcall_manager::configure(&managerAdminCap, &xcall_state, xm_carrier, string::utf8(ICON_BnUSD),  sources, destinations, 3, scenario.ctx());
        ...
        configure(&adminCap, treasuryCap, &xcallManagerConfig, &xcall_state, carrier, string::utf8(b"icon/hx534"),  3,  scenario.ctx());
