module balanced::balanced_token_crosschain {
    ...
    entry fun configure(_: &AdminCap, treasury_cap: TreasuryCap<BALANCED_TOKEN>, xcall_manager_config: &XcallManagerConfig, storage: &XCallState, witness_carrier: WitnessCarrier, icon_bnusd: String, version: u64, ctx: &mut TxContext ){
